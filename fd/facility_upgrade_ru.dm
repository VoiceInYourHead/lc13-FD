...
#undef PALE_BULLET
#undef YELLOW_BULLET
#undef UPGRADE_BULLET_COUNT
#undef UPGRADE_BULLET_HEAL
#undef UPGRADE_BULLET_SHIELD_HEALTH
#undef UPGRADE_AGENT_STATS
#undef UPGRADE_ABNO_QUEUE_COUNT
#undef UPGRADE_ABNO_MELT_TIME
