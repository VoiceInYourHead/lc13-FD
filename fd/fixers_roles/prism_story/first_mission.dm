...
//Я люблю травмировать своих игроков :)

/obj/structure/story_related/body_thorn
	name = "Gawain Thorn"
	desc = "He kinda alive, still...but his overall look isn't very promising."
	icon = 'fd/icons/npc.dmi'
	icon_state = "thorn"

	clue = "Это Гавейн. Один из нанятых нами для разведки Корректировщиков. Свою работу он выполнил на отлично, но почему-то так и не пришёл за наградой...это многое объясняет, боже. Парень дрожит в конвульсиях, его глаза закатаны ко лбу, а из рта и носа ручьями льётся кровь. Что бы ему не дали - на вряд ли мы обратим действие препарат вспять."
	difficulty = 0

/obj/structure/story_related/body_libra
	name = "Eizikaide Libra"
	desc = "Young girl with really, REALLY bad look. Oh god."
	icon = 'fd/icons/npc.dmi'
	icon_state = "libra"

	clue = "Это Либра. Напарница Гавейна. Они вдвоём взяли у нас небольшой разведывательный контракт. Выполнили его успешно, но почему-то так и не пришли за оплатой...господи, теперь понятно почему. Бедная девочка дрожит и извивается в предсмертных конвульсиях. Эти ублюдки сломали её во всех смыслах. Страшно представить, что они вытворяли с ней до нашего прибытия и сколько 'инъекций' ей успели сделать."
	difficulty = 0
